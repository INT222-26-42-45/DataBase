...
ALTER TABLE `ProductCart` ADD CONSTRAINT `productcart_pk` PRIMARY KEY ( `CartId`, `ProductId` );
...
ALTER TABLE `ProductCart`
    ADD CONSTRAINT `productcart_cart_fk` FOREIGN KEY ( `CartId` )
        REFERENCES `Carts` ( `CartId` );
ALTER TABLE `ProductCart`
    ADD CONSTRAINT `productcart_product_fk` FOREIGN KEY ( `ProductId` )
        REFERENCES `Products` ( `ProductId` );
ALTER TABLE `Products`
    ADD CONSTRAINT `product_user_fk` FOREIGN KEY ( `UserId` )
        REFERENCES `Users` ( `UserId` );
...
insert into `Carts` (CartId, Quantity, Total, UserId) values
(1, 2, 7400, 3),
(2, 1, 4200, 1),
(3, 2, 9000, 9),
(4, 1, 5000, 10),
...
insert  into `Products`(ProductId, ProductName, ProductDescription, ProductType, ProductSize, ProductPrice, ProductDate, ProductImg, BrandId, UserId) values 
(1, 'STAN SMITH', 'Trying to decide between sporty casual and dressed-up glam? Why not do both? These adidas Stan Smith shoes have the same buttery-soft leather upper as the 1971 original, dressed up with sparkling crystals from Swarovski.', 'Men/Women', '35.5-44', '3200.00', '2020-08-13', 'Stansmith.png', 1, 11),
...
(3, 'ULTRABOOST DNA', 'Run to move your body. Run to clear your head. The adidas Ultraboost DNA Shoes give you endless energy over the miles. The sleek silhouette makes them a favourite beyond the world of running. An adidas Primeknit upper brings comfort to your everyday wandering too.', 'Men/Women', '35.5-44', '6000.00', '2020-07-07', 'Ultraboostdna.png', 1, 5),
(4, 'ULTRABOOST 21', 'Prototype after prototype. Innovation after innovation. Testing after testing. Meet us in the hot pursuit of the pinnacle harmonization of weight, cushioning, and responsiveness. Ultraboost 21. Say hello to incredible energy return.', 'Men/Women', '35.5-44', '6500.00', '2020-08-21', 'Ultraboost21.png', 1, 4),
(5, 'Superstar', 'Designed for basketball in the 70s, glorified by hip-hop fans of the 80s, the adidas Superstar has become a must-have item for today street-dwellers. The world-famous seashell design retains the original style and protection of the basketball court, eliminating the worry of being hit by your feet at festivals or on the street. Maintain the original look with jagged 3-Stripes and the adidas Superstar logo in a square frame.', 'Men/Women', '35.5-44', '3200.00', '2020-08-15', 'Superstar.png', 1, 6),
(6, 'SLIP-ON SUPERSTAR', 'Why waste time tying your shoes? When you are ready to travel and teleport to meet your friends immediately. The adidas Superstar was originally an icon of the basketball court. But now it has become a shoe that stands out on the road, runway, or anywhere else, reinforcing its original design with a smooth upper and comfortable cups. Turn the top design from classic laces into straps for a sleek and easy slip-on style.', 'Men/Women', '35.5-44', '3200.00', '2020-12-06', 'Slipon.png', 1, 8),
(7, 'OZWEEGO ZIP', 'Yesterday from the 90s, cutting edge technology And perspectives of the future These adidas OZWEEGO shoes are ready to transform your look with bold style from the past and soft cushioning that will keep you moving forward. Into the future that belongs to you Zippered upper lets you put your shoes on and go quickly.', 'Men/Women', '35.5-44', '4700.00', '2020-10-05', 'Ozweego.png', 1, 10),
(8, 'Jordan delta2', 'The Jordan Delta 2 delivers fearless, fresh style that builds on the elements. You want durability, comfort and a Jordan-like attitude to the core - we have revamped the design lines and replaced some of the components.', 'Women', '35.5-40', '5000.00', '2020-02-01', 'Jordan Delta.png', 2, 9),
(9, 'Nike Air Force 1 Shadow', 'The Nike Air Force 1 Shadow brings a playful twist to a classic basketball shoe. Stand out by layering layers. It features a double-stacked brand and an enlarged midsole to emphasize a style approach and double the fun.', 'Women', '35.5-40', '4200.00', '2020-05-13', 'Air force 1.png', 2, 10), 
(10, 'Nike Air Force 1 LV8', 'Nike Air Force 1 has a new twist. Classic basketball shoes from 1982 reimagined for the game. (In a better way) with a pixelated Swoosh and an iridescent pearlescent. With all the details you know and love Who wants to play?', 'Men', '39-44', '2900.00', '2020-04-29', 'Air F LV8.png', 2, 3),
(11, 'Nike Air Force 1 07', 'Joy lives in the Nike Air Force 1 07, an iconic basketball shoe that brings a fresh twist to what you know best. Be it the sharp leather, the eye-catching colors and the perfect sparkle that makes you shine.', 'Women', '35.5-40', '3500.00', '2020-07-02', 'Air F 07.png', 2, 5),
(12, 'Nike OverBreak SP', 'The Nike OverBreak SP fuses iconic BRS track-shoe aesthetics with this sleek Nike OverReact accent, giving everyone an eye-popping style and superior comfort. There is an overlay from synthetic suede that is characterized by gradation dyeing for an added elegance While colorful laces and translucent toe caps are ready to show off.', 'Men', '39-44', '5200.00', '2020-11-11', 'Overbreak.png', 2, 7),
(13, 'Nike Blazer Mid 77 Vintage', 'In the 70s, Nike is shoes were the new shoes that just launched. Our brand at the time was still trying to pioneer the basketball scene. And still have to let the basketball team in the city try the shoes to test the prototype. Of course, the design is constantly evolving Over the years But the model name remains the same, the Nike Blazer Mid 77 Vintage has always been a classic. From the first day until today.', 'Men', '41-47', '3600.00', '2021-02-28', 'Blazer.png', 2, 10),
(14, 'Nike Dunk Low WMNS “Easter”', 'This Nike Dunk Low features a White leather base with pastel hues covering the overlays, Swooshes, tongue labels, heels, and inner lining. A White midsole atop a Yellow speckled rubber sole completes the design.', 'Women', '35.5-40', '3500.00', '2021-11-13', 'Dunk easter.png', 2, 9),
(15, 'Nike Air Max 90', 'The Nike Air Max 90 follows the original OG running shoe with a signature waffle outsole. Stitched outer overlay And TPU details highlight the classic style color New shades add power to the look The Max Air cushioning system adds comfort to the journey.', 'Women', '35.5-40', '4600.00', '2020-05-12', 'Airmax 90.png', 2, 8),
(16, 'Nike Air Flight 89', 'Keep the fun alive with the Nike Air Flight 89, the iconic basketball shoe that takes you back to OG basketball style with retro colors. The top cover from the leather is sharp. And the straps over the longer feet The pair pays homage to Nike is all-star all-star Roswell Rayguns, featuring retro Raygun colors and embroidered accents. And details according to other trends That will bring you back to the year 1975.', 'Men', '41-47', '4600.00', '2020-04-19', 'Air Flight.png', 2, 3),
(17, 'Mens Made in US 993', 'Superior comfort meets classic style in our men Made in US 993 running shoe. A favorite from the legendary 990 series, the 993 features responsive cushioning and premium materials ready for a run or all-day wear.', 'Men', '40-46', '5800.00', '2020-09-12', 'Mens.png', 3, 4),
(18, 'Fresh Foam Roav', 'The Fresh FoProductam Roav keeps you comfortable on the go. Fresh Foam cushioning creates a soft underfoot feel, while the Ultra Heel provides a snug, locked-in fit.', 'Men', '40-47', '2600.00', '2020-09-17', 'Fresh.png', 3, 6), 
...
(20, 'Numeric 440 High', 'Our New Balance Numeric NM440 is now available in a supportive high top with the NM440 High, blending premier technology with soft cushioning to create a go-to shoe for both everyday skate and wear. Featuring a 70s-inspired suede and mesh upper, this modern-retro shoe boasts both breathability and durability. A C-CAP heel wedge in the midsole helps protect against impact, while NDurance rubber outsole technology provides protection in high-wear areas to help get more out of these trusted shoes.', 'Women', '35.5-40', '3200.00', '2021-02-02', 'Numeric440.png', 3, 5),
...
/*Data for the table ProductCart*/
insert into `ProductCart` (CartId, ProductId) values
(1, 1),
(1, 9),
(2, 22),
(3, 23),
